...
class DicomWrapper:
    ...
    def get_location(self):
        ...
        direction = numpy.argmax(
            numpy.abs(numpy.cross(self.image_orientation_patient[:3], self.image_orientation_patient[3:])))
    ...
    def get_csv(self):
        res = [self.series_number, self.get_value("InstanceNumber"), self.flip_angle, self.series_description,
               self.series_time]
        return res
