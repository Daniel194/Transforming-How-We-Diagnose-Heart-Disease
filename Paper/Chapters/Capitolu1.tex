...
Din cauza variet\u{a}\c{t}ilor de pozi\c{t}ii prin care un pacient poate sta \^{i}ntr-un RMN, a multitudinilor de anatomii ale corpului \c{s}i a calit\u{a}\c{t}ii imaginii surprinse de RMN, fac ca m\u{a}surarea cantit\u{a}\c{t}ii de s\^{a}nge care curege prin ventriculul st\^{a}ng al inimii s\u{a} fie o adev\u{a}rat\u{a} provocare.
