...
\begin{figure}[h!]
  ...
  \captionsource{Compara\c{t}ie \^{i}ntre nivelele din re\c{t}elele neuronale \c{s}i nivelele din re\c{t}elele neuronale convolu\c{t}ionale}{\cite{Convolutional}}
\end{figure}
...
Nivelul convolu\c{t}ional este cel mai important nivel din cele trei \c{s}i cel care influen\c{t}eaz\u{a} cel mai mult deciziile re\c{t}elei neuronale. Acest nivel, ca \c{s}i nivelele din re\c{t}elele neuronale are dou\u{a} tipuri de paramterii, ponderile \c{s}i bias-urile, \^{i}ns\u{a} ponderile sunt organizate pe trei dimensiuni cum am discutat mai sus, astfel \^{i}nc\^{a}t acestea s\u{a} devin\u{a} ni\c{s}te filtre care \^{i}n urma aplic\u{a}rii lor asupra datelor de intrare s\u{a} scoat\u{a} \^{i}n eviden\c{t}\u{a} unele detalii descriminatorii care s\u{a} ajute la \^{i}ndeplinirea sarcinii, \^{i}ns\u{a} bias-urile sunt la fel ca la neuronii din re\c{t}elele neuronale obi\c{s}nuite. 
...
\begin{figure}[h!]
  ...
  \captionsource{Nivelul convolu\c{t}ional}{\cite{Michael_Nielsen}}
\end{figure}
...
\begin{figure}[h!]
  ...
  \captionsource{Nivelul de pool}{\cite{Michael_Nielsen}}
\end{figure}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=180]{original.png}
  \captionsource{Datele ini\c{t}iale}{\cite{Convolutional}}
\end{figure}

\begin{figure}[h!]
  \centering
  \includegraphics[width=180]{zero-centered.png}
  \captionsource{Centrarea la zero a datelor}{\cite{Convolutional}}
\end{figure}

\begin{figure}[h!]
  \centering
  \includegraphics[width=180]{normalization.png}
  \captionsource{Normalizarea datelor}{\cite{Convolutional}}
\end{figure}
